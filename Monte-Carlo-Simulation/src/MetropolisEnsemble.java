...
public abstract class MetropolisEnsemble implements IMolecularSimulation {
    ...
    final static double alw = 104.52;
    final static double dHOw = 0.9572;
	...
	protected abstract void engineMonteCarlo(int iMol, int iRan);
	
	private void initData(){
	
		MolecularModel waterModelWater = setupWaterModel();
...
//		ArrayList<Molecule> molecules = new ArrayList<Molecule>(numbMolsTotal);
		...
		calculateWaterEulerXYZ(molecules);
...
//		Setup of TIP3P model of water
	protected MolecularModel setupWaterModel(){
...
//		System.out.println(waterModelWater);
	...
	protected final void calculateRDF(){
